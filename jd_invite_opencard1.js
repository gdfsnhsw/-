...
function getActivityInfo() {
    return new Promise(resolve => {
        let body = 'activityId=cbb3f9d7ff9943df97d5118f1b1cc461';
...
function getInviteRecord() {
    return new Promise(resolve => {
        let body = 'activityId=cbb3f9d7ff9943df97d5118f1b1cc461&inviter=' + encodeURIComponent($.myPingData.secretPin) + '&pageNo=1&pageSize=15&type=0';
        let options = {
...
function getIsInvited() {
    return new Promise(resolve => {
        let body = 'activityId=cbb3f9d7ff9943df97d5118f1b1cc461&pin=' + encodeURIComponent($.myPingData.secretPin);
...
function getOpenCardAllStatuesNew() {
    return new Promise(resolve => {
        let body = 'activityId=cbb3f9d7ff9943df97d5118f1b1cc461&pin=' + encodeURIComponent($.myPingData.secretPin) + '&isInvited=1';
...
function ruhui2() {
    return {
        ...
        'headers': {
            ...
            'User-Agent': $.UA,
            'content-type': 'application/x-www-form-urlencoded',
            'Referer': 'https://shopmember.m.jd.com/shopcard/?venderId=10314962&shopId=10175519&channel=8802&returnUrl=https://cjhydz-isv.isvjcloud.com/microDz/invite/activity/wx/view/index/4438790?activityId=cbb3f9d7ff9943df97d5118f1b1cc461&inviter=' + $.DQCK + '&inviterImg=http://storage.360buyimg.com/i.imageUpload/6a645f3639613631633262633231303231363238313235383234363133_mid.jpg&inviterNickName=Tsukasa%E9%B1%BC%E8%9B%8B&shareuserid4minipg=DQCK%2FksVMxxhAtP2wbQfI9A1Drq3za4lh6LFLfledF1cdSiqMbCx5edEEaL3RnCSkdK3rLBQpEQH9V4tdrrh0w%3D%3D&shopid=599119&lng=113.388014&lat=22.510994&sid=09fdc8e908526b5538a4ad4a265f40dw&un_area=19_1657_52093_0',
            'Cookie': cookie
        }
    };
}
...
function getHtml() {
    return new Promise(resolve => {
        $.get({
            'url': 'https://cjhydz-isv.isvjcloud.com/microDz/invite/activity/wx/view/index/4438790?activityId=cbb3f9d7ff9943df97d5118f1b1cc461&inviter=' + $.inviter + '&inviterImg=http://storage.360buyimg.com/i.imageUpload/6a645f3639613631633262633231303231363238313235383234363133_mid.jpg&inviterNickName=Tsukasa%E9%B1%BC%E8%9B%8B&shareuserid4minipg=DQCK%2FksVMxxhAtP2wbQfI9A1Drq3za4lh6LFLfledF1cdSiqMbCx5edEEaL3RnCSkdK3rLBQpEQH9V4tdrrh0w%3D%3D&shopid=599119&lng=113.388014&lat=22.510994&sid=09fdc8e908526b5538a4ad4a265f40dw&un_area=19_1657_52093_0',
            'headers': {
                'User-Agent': $.UA,
                'Host': 'cjhydz-isv.isvjcloud.com',
...
function getSystemConfig() {
    return new Promise(resolve => {
        let options = {
            ...
            'body': 'activityId=cbb3f9d7ff9943df97d5118f1b1cc461',
            'headers': {
                'Host': 'cjhydz-isv.isvjcloud.com',
                'Accept': 'application/json',
                'X-Requested-With': 'XMLHttpRequest',
    ...
    return new Promise(resolve => {
        let options = {
            ...
            'headers': {
                ...
                'Origin': 'https://cjhydz-isv.isvjcloud.com',
                'Connection': 'keep-alive',
                'Referer': 'https://cjhydz-isv.isvjcloud.com/microDz/invite/activity/wx/view/index/2693797?activityId=cbb3f9d7ff9943df97d5118f1b1cc461',
                'User-Agent': $.UA,
                'Cookie': ' LZ_TOKEN_KEY=' + $.LZ_TOKEN_KEY + '; LZ_TOKEN_VALUE=' + $.LZ_TOKEN_VALUE
            }
        }
...
function index() {
    return new Promise(resolve => {
        let _0x15bbca = 'activityId=cbb3f9d7ff9943df97d5118f1b1cc461';
        $.get({
