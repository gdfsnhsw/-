...
let activityUrl = "https://lzkjdz-isv.isvjcloud.com/pool/captain/6029392?activityId=7dee74f982034f5496a469ecdb4b05f2&signUuid=7fcf95c870054ba2a507155b39f6317b&shareuserid4minipg=wL1GFYiFmVU3KttngoTUgGwklxRrP5C78lmKjh9Mn4avAmNuF4i+OHS9NlRdtagP&shopid=1000002527"
let activityId = ""
let venderId = ""
let shopId = ""
let sid = ""
let sidUuid=""
if(process.env.ZUDUI_CAPTAIN_ACTIVITY_URL){
    activityUrl = process.env.ZUDUI_CAPTAIN_ACTIVITY_URL
    ...
    return new Promise(resolve => {
        let options = {
            ...
            headers: {
                ...
                'Referer':`https://lzkjdz-isv.isvjcloud.com/pool/activity?activityId=${$.activityId}&signUuid=${$.signUuid}&shareuserid4minipg=${encodeURIComponent($.shareuserid4minipg)}&shopid=${$.shopid}&lng=113.260026&lat=23.175425&sid=7701253addf4a287f04f595ed441b45w&un_area=19_1601_50258_50374`,
    ...
    return new Promise(resolve => {
        let options = {
            ...
            headers: {
                ...
                'Referer':`https://lzkjdz-isv.isvjcloud.com/pool/captain/4207179?activityId=${activityId}&signUuid=${sidUuid}&shareuserid4minipg=${$.secretPin}&shopid=${$.shopid}`,
    ...
    return new Promise(resolve => {
        let options = {
            ...
            headers: {
                ...
                'Host':'lzkjdz-isv.isvjd.com',
                'Origin':'https://lzkjdz-isv.isvjd.com',
                'Referer':`https://lzkjdz-isv.isvjcloud.com/pool/captain/941462?activityId=${activityId}&signUuid=${$.signId}&shareuserid4minipg=${encodeURIComponent($.firstSecretPin)}&shopid=${venderId}`,
...
function drawContent() {
    return new Promise(resolve => {
        ...
        $.post(taskPostUrl('/dingzhi/taskact/superfanscommon/drawContent',body), async(err, resp, data) => {
            try {
                if (err) {
...
function accessActivity() {
    return new Promise(resolve => {
        let options = {
            url: `https://lzkjdz-isv.isvjcloud.com/pool/captain/2920625?activityId=${activityId}`,
            headers: {
                'User-Agent': $.UA,
                'Cookie': `${cookie}`,
                'Host':'lzkjdz-isv.isvjcloud.com'
...
function accessLogWithAD() {
    return new Promise(resolve => {
        let pageUrl = `https://lzkjdz-isv.isvjcloud.com/pool/captain/1206424?activityId=${activityId}&signUuid=${$.signId}`
        let options = {
            ...
            headers: {
                ...
                'Host':'lzkjdz-isv.isvjd.com',
                'Origin':'https://lzkjdz-isv.isvjd.com',
                'Referer':`https://lzkjdz-isv.isvjcloud.com/pool/captain/1206424?activityId=${activityId}&signUuid=${$.signId}&shareuserid4minipg=${$.firstSecretPin}&shopid=${venderId}`,
    ...
    return new Promise(resolve => {
        let options = {
            ...
            headers: {
                ...
                'Host':'lzkjdz-isv.isvjd.com',
                'Origin':'https://lzkjdz-isv.isvjd.com',
                'Referer':`https://lzkjdz-isv.isvjcloud.com/pool/captain/941462?activityId=${activityId}&signUuid=${$.signId}&shareuserid4minipg=${encodeURIComponent($.firstSecretPin)}`,
                'Cookie': `LZ_TOKEN_KEY=${$.LZ_TOKEN_KEY}; LZ_TOKEN_VALUE=${$.LZ_TOKEN_VALUE};AUTH_C_USER=${$.AUTH_C_USER};lz_jdpin_token=${$.lz_jdpin_token};lz_wq_auth_token=${$.isvObfuscatorToken}`,
            }
        }
        $.post(options, async (err, resp, data) => {
