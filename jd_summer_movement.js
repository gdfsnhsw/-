...
$.appid = 'o2_act';
let UA = `jdapp;iPhone;10.0.6;14.6;${randomString(40)};network/wifi;model/iPhone13,2;addressid/1533408821;appBuild/167724;jdSupportDarkMode/0;Mozilla/5.0 (iPhone; CPU iPhone OS 14_6 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148;supportJDSHWK/1`
...
!(async () => {
    ...
    for (let i = 0; i < cookiesArr.length; i++) {
        if (cookiesArr[i]) {
            ...
            $.nickName = $.UserName;
            $.hotFlag = false; //是否火爆
            UA = `jdapp;iPhone;10.0.6;14.6;${randomString(40)};network/wifi;model/iPhone13,2;addressid/1533408821;appBuild/167724;jdSupportDarkMode/0;Mozilla/5.0 (iPhone; CPU iPhone OS 14_6 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148;supportJDSHWK/1`
