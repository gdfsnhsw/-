...
function draw() {
    return new Promise(resolve => {
        let body = `activityId=${$.activityId}&actorUuid=${$.actorUuid}&pin=${encodeURIComponent($.Pin)}`
        const options = taskPostUrl('/dingzhi/midautumn/jointactivity/draw', body);
...
function shopactivityId(functionId) {
    return {
        ...
        headers: {
            ...
            'Referer': `https://shopmember.m.jd.com/shopcard/?venderId=${functionId}&shopId=${functionId}&venderType=5&channel=401&returnUrl=https://lzdz1-isv.isvjcloud.com/dingzhi/midautumn/jointactivity/activity/1988328?activityId=${$.activityId}&shareUuid=${$.shareUuid}`,
            'Cookie': cookie
        }
    }
}
...
function accessLogWithAD() {
    return new Promise(resolve => {
        let pageurl = `https://lzdz1-isv.isvjcloud.com/dingzhi/midautumn/jointactivity/activity/1988328?activityId=${$.activityId}&shareUuid=${$.shareUuid}`
...
function getCk() {
    return new Promise(resolve => {
        let get = {
            url:`https://lzdz1-isv.isvjcloud.com/dingzhi/midautumn/jointactivity/activity/1988328?activityId=${$.activityId}&shareUuid=${$.shareUuid}`,
            headers: {
                "Cookie": cookie,
                "User-Agent": $.UA,
            }
...
function taskPostUrl(url, body) {
    return {
        ...
        headers: {
            ...
            "Referer": `https://lzdz1-isv.isvjcloud.com/dingzhi/midautumn/jointactivity/activity/1988328?activityId=${$.activityId}&shareUuid=${$.shareUuid}`,
            "User-Agent": $.UA ,
        }
    }
}
