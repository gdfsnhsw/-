...
let activityUrl = "https://lzkjdz-isv.isvjcloud.com/wxCollectCard/activity/5958509?activityId=1c9d6b9579804cb580c41c6549cd0e03&shareUuid=ba931c385d154de794d8ac69ba3a809f&shareuserid4minipg=vpEngaUCWUkBQSOdWqVJNE7oeVP9kq2pYSH90mYt4m3fwcJlClpxrfmVYaGKuquQkdK3rLBQpEQH9V4tdrrh0w==&shopid=1000002523"
let activityId = ""
let venderId = ""
let shopId = ""
let sid = ""
...
!(async () => {
    ...
    for (let i = 0; i < cookiesArr.length; i++) {
        ...
        if (cookie) {
            ...
            if($.index == 1){
                await shopInfo("wxCollectCard");

                if(!sidUuid){
                    await getSignId("wxCollectCard");
...
function activityContent() {
    return new Promise(resolve => {
        let options = {
            url: `https://lzkjdz-isv.isvjcloud.com/wxCollectCard/activityContent`,
            body: `activityId=${activityId}&pin=${encodeURIComponent($.secretPin)}&uuid=${$.signId}`,
            headers: {
                ...
                'Referer':`https://lzkjdz-isv.isvjcloud.com/wxCollectCard/activity?activityId=${$.activityId}&shareUuid=${$.signId}&shareuserid4minipg=${encodeURIComponent($.shareuserid4minipg)}&shopid=${$.shopid}&lng=113.260026&lat=23.175425&sid=7701253addf4a287f04f595ed441b45w&un_area=19_1601_50258_50374`,
...
function saveCaptain() {
    ...
    return new Promise(resolve => {
        let options = {
            url: `https://lzkjdz-isv.isvjcloud.com/wxCollectCard/saveCaptain`,
            ...
            headers: {
                ...
                'Referer':`https://lzkjdz-isv.isvjcloud.com/wxCollectCard/activity/4207179?activityId=${activityId}&signUuid=${sidUuid}&shareuserid4minipg=${$.secretPin}&shopid=${$.shopid}`,
...
function drawContent() {
    return new Promise(resolve => {
        let options = {
            url: `https://lzkjdz-isv.isvjcloud.com/wxCollectCard/drawContent`,
            ...
            headers: {
                ...
                'Host':'lzkjdz-isv.isvjd.com',
                'Origin':'https://lzkjdz-isv.isvjd.com',
                'Referer':`https://lzkjdz-isv.isvjcloud.com/wxCollectCard/activity/941462?activityId=${activityId}&signUuid=${$.signId}&shareuserid4minipg=${encodeURIComponent($.firstSecretPin)}&shopid=${venderId}`,
...
function drawCard() {
    return new Promise(resolve => {
        let options = {
            url: `https://lzkjdz-isv.isvjcloud.com/wxCollectCard/drawCard`,
            body: `activityId=${activityId}&pin=${encodeURIComponent($.secretPin)}&type=1&sourceId=${$.signId}&pinImg=${encodeURIComponent("http://storage.360buyimg.com/i.imageUpload/6a645f3437633463333562316434363231353937323838313433353232_mid.jpg")}`,
            headers: {
                'Accept':'application/json, text/javascript, */*; q=0.01',
                'User-Agent': $.UA,
                'Content-Type':'application/x-www-form-urlencoded; charset=UTF-8',
...
function accessActivity() {
    return new Promise(resolve => {
        let options = {
            url: `https://lzkjdz-isv.isvjcloud.com/wxCollectCard/activity/2920625?activityId=${activityId}`,
            headers: {
                'User-Agent': $.UA,
                'Cookie': `${cookie}`,
                'Host':'lzkjdz-isv.isvjcloud.com'
...
function accessLogWithAD() {
    return new Promise(resolve => {
        let pageUrl = `https://lzkjdz-isv.isvjcloud.com/wxCollectCard/activity/1206424?activityId=${activityId}&signUuid=${$.signId}`
        let options = {
            ...
            headers: {
                ...
                'Host':'lzkjdz-isv.isvjd.com',
                'Origin':'https://lzkjdz-isv.isvjd.com',
                'Referer':`https://lzkjdz-isv.isvjcloud.com/wxCollectCard/activity/1206424?activityId=${activityId}&signUuid=${$.signId}&shareuserid4minipg=${$.firstSecretPin}&shopid=${venderId}`,
    ...
    return new Promise(resolve => {
        let options = {
            ...
            headers: {
                ...
                'Host':'lzkjdz-isv.isvjd.com',
                'Origin':'https://lzkjdz-isv.isvjd.com',
                'Referer':`https://lzkjdz-isv.isvjcloud.com/wxCollectCard/activity/941462?activityId=${activityId}&signUuid=${$.signId}&shareuserid4minipg=${encodeURIComponent($.firstSecretPin)}`,
                'Cookie': `LZ_TOKEN_KEY=${$.LZ_TOKEN_KEY}; LZ_TOKEN_VALUE=${$.LZ_TOKEN_VALUE};AUTH_C_USER=${$.AUTH_C_USER};lz_jdpin_token=${$.lz_jdpin_token};lz_wq_auth_token=${$.isvObfuscatorToken}`,
            }
        }
        $.post(options, async (err, resp, data) => {
