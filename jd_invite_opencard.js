...
function getActivityInfo() {
    ...
    return new Promise(_0x40b382 => {
        ...
        let _0x4d2db4 = 'activityId=d659ea682e7547d8a6079e49a7c4cbeb';
...
function getInviteRecord() {
    ...
    return new Promise(_0x518317 => {
        ...
        if (_0x58ad78['PtbrW'](_0x58ad78['uJIig'], _0x58ad78['uVMTD'])) {
            ...
            let _0x40c9a7 = 'activityId=d659ea682e7547d8a6079e49a7c4cbeb&inviter=' + _0x58ad78['pAQhH'](encodeURIComponent, $['myPingData']['secretPin']) + '&pageNo=1&pageSize=15&type=0';
...
function getIsInvited() {
    ...
    return new Promise(_0x69e259 => {
        if (_0x30ec6e['llVOw'](_0x30ec6e['ODrAe'], _0x30ec6e['uMmWW'])) {
            ...
            let _0x241660 = 'activityId=d659ea682e7547d8a6079e49a7c4cbeb&pin=' + _0x30ec6e['essml'](encodeURIComponent, $['myPingData']['secretPin']);
...
function getOpenCardAllStatuesNew() {
    ...
    return new Promise(_0x887d17 => {
        ...
        if (_0x32c81b['sUNIy']('AQnzL', _0x32c81b['XcgnA'])) {
            ...
            let _0x211cef = 'activityId=d659ea682e7547d8a6079e49a7c4cbeb&pin=' + _0x32c81b['pQbEN'](encodeURIComponent, $['myPingData']['secretPin']) + '&isInvited=1';
...
function ruhui2() {
    ...
    return {
        ...
        'headers': {
            ...
            'Referer': 'https://shopmember.m.jd.com/shopcard/?venderId=10314962&shopId=10175519&channel=8802&returnUrl=https://cjhydz-isv.isvjcloud.com/microDz/invite/activity/wx/view/index/4438790?activityId=d659ea682e7547d8a6079e49a7c4cbeb&inviter=' + $['DQCK'] + '&inviterImg=http://storage.360buyimg.com/i.imageUpload/6a645f3639613631633262633231303231363238313235383234363133_mid.jpg&inviterNickName=Tsukasa%E9%B1%BC%E8%9B%8B&shareuserid4minipg=DQCK%2FksVMxxhAtP2wbQfI9A1Drq3za4lh6LFLfledF1cdSiqMbCx5edEEaL3RnCSkdK3rLBQpEQH9V4tdrrh0w%3D%3D&shopid=599119&lng=113.388014&lat=22.510994&sid=09fdc8e908526b5538a4ad4a265f40dw&un_area=19_1657_52093_0',
            'Cookie': cookie
        }
    };
}
...
function getHtml() {
    ...
    return new Promise(_0x170b10 => {
        ...
        if (_0x33b19c['MagFp'](_0x33b19c['JjnVD'], _0x33b19c['JLlBK'])) {
            $['get']({
                'url': 'https://cjhydz-isv.isvjcloud.com/microDz/invite/activity/wx/view/index/4438790?activityId=d659ea682e7547d8a6079e49a7c4cbeb&inviter=' + $['inviter'] + '&inviterImg=http://storage.360buyimg.com/i.imageUpload/6a645f3639613631633262633231303231363238313235383234363133_mid.jpg&inviterNickName=Tsukasa%E9%B1%BC%E8%9B%8B&shareuserid4minipg=DQCK%2FksVMxxhAtP2wbQfI9A1Drq3za4lh6LFLfledF1cdSiqMbCx5edEEaL3RnCSkdK3rLBQpEQH9V4tdrrh0w%3D%3D&shopid=599119&lng=113.388014&lat=22.510994&sid=09fdc8e908526b5538a4ad4a265f40dw&un_area=19_1657_52093_0',
                'headers': {
                    'User-Agent': 'Mozilla/5.0 (iPhone; CPU iPhone OS 11_0 like Mac OS X) AppleWebKit/604.1.38 (KHTML, like Gecko) Version/11.0 Mobile/15A372 Safari/604.1',
                    'Host': 'cjhydz-isv.isvjcloud.com',
